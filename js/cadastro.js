    ...
    function handleFontSizeChange() {
        clearTimeout(scrollTimeout); // Limpa o timeout anterior se o usuário continuar clicando

        ignoreScroll = true; // Ignora o scroll enquanto os botões são clicados

        // Define um timeout para reativar o comportamento de scroll após 1 segundo de inatividade
        scrollTimeout = setTimeout(function () {
            ignoreScroll = false;
        }, 300);
    }

    // Eventos para aumentar ou diminuir o tamanho da fonte
